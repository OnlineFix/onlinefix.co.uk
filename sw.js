...
const SHELL_URLS = [
    '/',
    '/index.html',
    '/css/core.min.css?v=20260609',
    '/css/icons.min.css?v=20260609',
    '/js/core.js?v=20260609',
    '/js/cookies.js?v=20260609',
    '/images/onlinefix-logo.webp?v=2',
    '/favicon-192x192.png',
    '/favicon-512x512.png?v=2',
